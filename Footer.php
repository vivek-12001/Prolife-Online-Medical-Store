...
<html lang="en">
    ...
    <body>
        ...
        <div class="container text-center text-md-left">
            <div class="row">
                <div class="col-md-4 mx-auto">
                    <a style="color:white;margin-right:10vw;font-family:'Gabriola', Arial;font-size:4em;">Pro-Life</a>
                ...
                <div class="col-md-2 mx-auto">
                    <h5 class="font-weight-bold text-uppercase mt-3 mb-2"><a href="aboutus.php">About Us</a></h5>
                ...
                <hr class="clearfix w-100 d-md-none">
                <div class="col-md-2 mx-auto">
                    <h5 class="font-weight-bold text-uppercase mt-3 mb-2"><a href="contactus.php">Contact Us</a></h5>
                    <!--<ul class="list-unstyled">-->
                    <!--<li><a href="#!">Link 1</a></li>-->
                    <!--<li><a href="#!">Link 2</a></li>-->
                    <!--</ul>-->
        ...
        <div class="footer-copyright text-center py-3">© 2019 Copyright:
            <a href="https://mdbootstrap.com/education/bootstrap/"> Pro-Life</a>
        </div>
        </footer>
    </body>
</html>